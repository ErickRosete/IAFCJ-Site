      ...
      <div className="about">
        ...
        <div className="about__summary">
          <p className="about__summary-par1">
            ...
            fe, hubo la promesa del Salvador. Dios amó tanto que nos envió a su
            único hijo "
          </p>
          <p className="about__summary-par2">
            ... hasta que hubo esperanza, hubo fe, hubo la promesa del Salvador.
            Dios amó tanto que nos envió a su único hijo "
          </p>
        </div>
